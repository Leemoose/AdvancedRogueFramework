...
from monster_implementation import MonsterAI, create_goblin_behaviors
...
class Goblin(Monster):
    def __init__(self, x=-1, y=-1, render_tag=1010, name="Goblin", experience_given=10, health=10, min_damage=1, max_damage=3, rarity="Common"):
